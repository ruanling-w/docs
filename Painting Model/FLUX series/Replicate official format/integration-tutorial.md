...
### Official Replicate Format Call

| Contact customer service to add if needed.
...
2. Generating a task using the `.version` method
   Taking `lucataco/flux-schnell-lora` as an example
   Refer to the documentation: https://replicate.com/lucataco/flux-schnell-lora?input=http
   The version obtained from the documentation is 2a6b576af31790b470f0a8442e1e9791213fa13799cbb65a9fc1436e96389574
...
The return body format is consistent with the above.
Retrieve Task
Obtain the task ID through the above output.
The result is in the key field "output".
Note that the return result and its linked file have time limits.
