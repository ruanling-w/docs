# doubao-seedream-4-5-251128 Single Image to Multi-Image
...
paths:
  /v1/images/generations:
    post:
      summary: doubao-seedream-4-5-251128  Single Image to Multi-Image
      deprecated: false
      description: |+
            ...
            example: |-
              {
                ...
                "prompt": "Refer to this LOGO, create a set of visual designs for an outdoor sports brand named 'GREEN', including packaging bags, hats, cards, lanyards, etc. The main color tone is green, with a fun, simple, and modern style.",
