# doubao-seedream-4-5-251128 Image-and-Text-to-Image (Single Image Input, Single Image Output)
...
paths:
  /v1/images/generations:
    post:
      summary: doubao-seedream-4-5-251128  Image-and-Text-to-Image (Single Image Input, Single Image Output)
      deprecated: false
      description: |+
        ...
        content:
          application/json:
            ...
            example:
              ...
              prompt: >-
                Keep the model's pose and the flowing shape of the liquid clothing unchanged. Change the clothing material from silver metal to completely transparent clear water (or glass). Through the liquid water flow, you can see the skin details of the model. The light and shadow change from reflection to refraction.
              image: >-
