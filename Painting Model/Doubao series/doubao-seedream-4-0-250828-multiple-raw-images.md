...
paths:
  /v1/images/generations:
    post:
      summary: "doubao-seedream-4-0-250828-Multi-Image-Generation"
      deprecated: false
      description: |+
                ...
                sequential_image_generation_options:
                  ...
                  properties:
                    max_images:
                      type: integer
                      description: |-
                        Specify the maximum number of images that can be generated in this request. Default is 15
                        Value range: [1, 15]
                  x-apifox-orders:
                    - max_images
                  description: Configuration for the multi-image feature. Only effective when sequential_image_generation is set to auto.
                response_format:
                  type: string
                  description: |-
