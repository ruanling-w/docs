# doubao-seedream-4-5-251128 Multi-Image Output (Multiple Images Output)
...
paths:
  /v1/images/generations:
    post:
      summary: doubao-seedream-4-5-251128  Multi-Image Output (Multiple Images Output)
      deprecated: false
      description: |+
        ...
        content:
          application/json:
            ...
            example:
              ...
              prompt: Generate a set of 4 coherent illustrations, centered on the seasonal changes of the same corner of a courtyard, showcasing the unique colors, elements, and atmosphere of each season in a unified style
              size: 2K
