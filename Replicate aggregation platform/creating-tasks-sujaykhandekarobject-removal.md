...
paths:
  /replicate/v1/predictions:
    post:
      summary: Create task sujaykhandekar/object-removal
      deprecated: false
      description: Official documentation:https://replicate.com/sujaykhandekar/object-removal
      tags:
              ...
              properties:
                ...
                input:
                  ...
                  properties:
                    image_path:
                      type: string
                      description: Input image (ideally a square image)
                    objects_to_remove:
                      type: string
                      description: >-
                        The objects to be removed (separated by commas, e.g., car, cat, bird). For a complete list of names, please visit https://github.com/sujaykhandekar/Automated-objects-removal-inpainter/blob/master/segmentation_classes.txt.
                  required:
                    - image_path
                  x-apifox-orders:
                    - image_path
