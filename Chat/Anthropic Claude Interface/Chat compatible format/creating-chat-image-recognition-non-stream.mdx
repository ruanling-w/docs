---
title: "Create Chat Vision (Non-Streaming)"
api: "POST /v1/chat/completions"
description: "Generates a response for a prompt containing images using a non-streaming connection."
---

This endpoint allows you to send images as part of the conversation for recognition and analysis.
    ...
    <ParamField body="image_url" type="object">
      <Expandable title="properties">
        <ParamField body="url" type="string">
          The URL of the image or base64 encoded data.
        </ParamField>
      </Expandable>
    </ParamField>
  </Expandable>
