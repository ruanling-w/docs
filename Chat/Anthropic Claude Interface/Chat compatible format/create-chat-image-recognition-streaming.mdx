---
title: "Create Chat Vision (Streaming)"
api: "POST /v1/chat/completions"
description: "Generates a streamed chat completion response with image recognition."
---

This endpoint allows for vision-based chat completions with streaming.

### Request Body

<ParamField body="model" type="string" required>
  The vision-capable model ID (e.g., `claude-3-5-sonnet-20240620`).
</ParamField>

<ParamField body="messages" type="array" required>
  Conversation history including images.
  <Expandable title="content details">
    Images can be provided as base64 data or URLs depending on model support.
  </Expandable>
</ParamField>
...
```http Response
data: {"id":"chatcmpl-123", ... "choices":[{"index":0,"delta":{"content":"The image shows..."},"finish_reason":null}]}
data: [DONE]
```
