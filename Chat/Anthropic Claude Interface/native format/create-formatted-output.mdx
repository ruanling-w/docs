---
title: "Create Formatted Output"
api: "POST /v1/messages"
description: "Generates structured or formatted output using the Messages API."
---

Force the model to provide responses in a specific format, such as JSON or a custom structure.
...
<ParamField body="system" type="string">
  System prompt to define the output format and constraints.
</ParamField>
