---
title: "PDF Support (URL)"
api: "POST /v1/messages"
description: "Generates a response for messages containing PDF documents via URL."
---

Claude can process PDF documents. This endpoint demonstrates how to provide a PDF via a publicly accessible URL.
...
```json Response
{
  ...
  "content": [
    {
      "type": "text",
      "text": "The PDF document contains a summary of the quarterly financial report."
    }
  ],
