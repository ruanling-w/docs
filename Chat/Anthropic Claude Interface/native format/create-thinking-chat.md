...
paths:
  /v1/messages:
    post:
      summary: Create a Thinking Chat
      deprecated: false
      description: >
        The model will return the completion of one or more predictions, and can also return the probability of the alternative label at each location.

        Complete with the provided hints and parameters

        Official documentation: https://docs.anthropic.com/en/docs/build-with-claude/extended-thinking
      tags:
        - Chat/Anthropic Claude Interface/Native Format
      parameters:
        - name: Content-Type
          in: header
          description: ""
