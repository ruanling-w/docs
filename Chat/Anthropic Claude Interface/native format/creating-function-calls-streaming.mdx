---
title: "Create Function Calls (Streaming)"
api: "POST /v1/messages"
description: "Generates a streaming response with tool use/function calls using the Messages API."
---

The Messages API allows Claude to use external tools. This endpoint streams the tool use process.
...
<ParamField body="tools" type="array" required>
  Definitions of tools available to the model.
</ParamField>
