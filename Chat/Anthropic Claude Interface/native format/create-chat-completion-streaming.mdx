...
description: "Generates a streaming response for the provided messages using the Anthropic native format."
---

The Messages API allows you to send a list of structured messages and receive a streaming response from the model.
...
<ParamField body="stream" type="boolean" default="true">
  Whether to stream the response. Must be `true` for this endpoint.
</ParamField>
