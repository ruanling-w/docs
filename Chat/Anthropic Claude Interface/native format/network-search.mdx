...
description: "Generates a response using Claude's web search tool capability internally."
---

This endpoint allows Claude to access the internet to provide up-to-date information.
...
<ParamField body="tools" type="array">
  Include a `web_search` tool definition if required by the model configuration.
</ParamField>
...
```json Response
{
  ...
  "content": [
    {
      "type": "text",
      "text": "Based on my web search, the current price for Bitcoin is..."
    }
  ],
