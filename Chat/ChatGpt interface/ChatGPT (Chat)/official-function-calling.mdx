---
title: "Official Function Calling"
api: "POST /v1/chat/completions"
description: "Standard implementation of function calling using tools."
---

Connect models to external APIs and tools using the modern `tools` parameter.
