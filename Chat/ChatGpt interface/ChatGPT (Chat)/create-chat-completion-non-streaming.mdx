...
description: "Generates a chat completion for the provided prompt and parameters."
---

The Chat Completion API provides a robust interface for generating text responses from OpenAI models like GPT-4o.
...
<ParamField body="stream" type="boolean" default="false">
  Whether to stream the response. Set to `false` for this endpoint.
</ParamField>
