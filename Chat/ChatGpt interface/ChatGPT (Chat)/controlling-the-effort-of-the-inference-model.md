# Controlling the effort level of the inference model
...
paths:
  /v1/chat/completions:
    post:
      summary: Controlling the effort level of the inference model
      deprecated: false
      description: >-
        ...
        Official documentation: https://platform.openai.com/docs/guides/reasoning?api-mode=responses
      tags:
