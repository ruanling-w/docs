---
title: "Create Image Recognition Chat (Non-Streaming)"
api: "POST /v1/chat/completions"
description: "Generates a response for a prompt containing images using a non-streaming connection."
---

OpenAI models like `gpt-4o` support vision capabilities, allowing you to include images in your conversation.
...
<ParamField body="messages" type="array" required>
  List of messages, including image content.
  <Expandable title="content item">
    <ParamField body="type" type="string" required>
      Set to `image_url` for image content.
    </ParamField>
    <ParamField body="image_url" type="object" required>
      <Expandable title="properties">
        <ParamField body="url" type="string" required>
          The URL of the image or base64 data string (e.g., `data:image/jpeg;base64,...`).
        </ParamField>
        <ParamField body="detail" type="string" default="auto">
          Specifies the detail level of the image processing (`low`, `high`, `auto`).
        </ParamField>
      </Expandable>
    </ParamField>
  </Expandable>
  ...
  "choices": [
    {
      "message": {
        "role": "assistant",
        "content": "This image shows a white cat sitting on a wooden fence."
      }
    }
  ]
}
