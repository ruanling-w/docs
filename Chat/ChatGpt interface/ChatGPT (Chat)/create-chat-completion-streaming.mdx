...
description: "Generates a streaming chat completion for the provided prompt and parameters."
---

Stream token delivery for real-time applications using Server-Sent Events (SSE).

### Request Body

<ParamField body="model" type="string" required>
  The ID of the model to use (e.g., `gpt-4o`).
</ParamField>
...
<ParamField body="stream_options" type="object">
  ...
  <Expandable title="properties">
    <ParamField body="include_usage" type="boolean">
      If set, an additional chunk will be sent at the end of the stream with usage statistics.
    </ParamField>
  </Expandable>
</ParamField>
