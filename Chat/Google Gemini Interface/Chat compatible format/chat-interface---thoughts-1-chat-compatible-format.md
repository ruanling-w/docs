# Chat Interface - Thoughts 1 [Chat Compatible Format]
...
paths:
  /v1/chat/completions:
    post:
      summary: "Chat Interface - Thoughts 1 [Chat Compatible Format] "
      deprecated: false
      description: |-
        ...
        Official documentation: https://ai.google.dev/gemini-api/docs/text-generation?hl=zh-cn
      tags:
        - Chat/Google Gemini API/Chat compatible formats
      parameters:
        - name: Content-Type
          in: header
          description: ""
            ...
            schema:
              ...
              properties:
                model:
                  type: string
                  description: |+
                    The ID of the model used. For details on which models can be used with the chat API, please refer to the Model Endpoint Compatibility Table.
      ...
      security:
        - bearer: []
      x-apifox-folder: Chat/Google Gemini API/Chat compatible formats
