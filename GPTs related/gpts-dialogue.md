...
paths:
  /v1/chat/completions:
    post:
      summary: GPTs Dialogue
      deprecated: false
      description: |-
        The model name format is: gpt-4-gizmo-*, which the system will automatically recognize.

        For example, this GPT: https://chatgpt.com/g/g-B3hgivKK9-write-for-me

        Then its model name should be: gpt-4-gizmo-g-B3hgivKK9
              ...
              properties:
                ...
                "n":
                  ...
                  description: |-
                    ...
                    This determines how many chat completion options are generated for each input message.
                stream:
                  type: boolean
                  description: >-
                ...
                tool_choice:
                  ...
                  properties: {}
                  description: >-
                    A list of tools that the model can invoke. Currently, only functions as tools are supported. Use this feature to provide a list of functions that the model can use to generate JSON input.
                  x-apifox-orders: []
              required:
                - model
                - messages
