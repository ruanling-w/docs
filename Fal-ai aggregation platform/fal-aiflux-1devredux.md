...
paths:
  /fal-ai/flux-1/dev/redux:
    post:
      ...
      deprecated: false
      description: 'Official documentation: https://fal.ai/models/fal-ai/flux-1/dev/redux'
      tags:
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                num_inference_steps:
                  type: integer
                  description: Number of inference steps to be performed. Default: 28. Range: 1-50
                guidance_scale:
                  type: number
